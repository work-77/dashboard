...
export const menuItems = [
  ...
  {
    name: 'Projects',
    href: routes.REProjects.dashboard,
    icon: <PiClipboardTextDuotone />,
  },
  {
    name: 'Properties',
    href: routes.properties.dashboard,
    icon: <PiHouseLineDuotone />,
  },
  {
    name: 'Features',
    href: routes.features.dashboard,
    icon: <PiSquaresFourDuotone />,
  },
  {
    name: 'Users',
    href: routes.usersManager.dashboard,
    icon: <PiUserDuotone />,
  },
  {
    name: 'Developers',
    href: routes.reDevs.dashboard,
    icon: <PiShapesDuotone />,
  },
  {
    name: 'Addresses',
    href: routes.addresses.dashboard,
    icon: <PiNewspaperClippingDuotone />,
  },
  {
    name: 'Locations',
    href: routes.locations.dashboard,
